...
// NOVA launch: 40 days from September 1, 2026
const LAUNCH_DATE = new Date("2026-10-11T20:00:00+03:30").getTime();
...
const faqs = [
  {
    ...
    a: "NOVA is currently preparing for launch. Follow our official X and Telegram channels for the latest announcements.",
  },
  {
    q: "How can I buy NOVA?",
    a: "Buying information will be published after the official launch and verified contract address are available.",
  },
  {
    q: "Which wallet can I use?",
    a: "Wallet support and network information will be announced before launch.",
  },
  {
    q: "Will there be a presale?",
    a: "Official information about the launch structure will only be published through NOVA's official channels.",
  },
  {
    q: "Is NOVA audited?",
    a: "Audit information will be displayed here if an independent audit is completed.",
  },
  {
    q: "Is this a long-term project?",
    a: "NOVA is being built as a community-focused internet brand with a long-term vision.",
  },
];
...
export default function Home() {
  ...
  const copyContract = async () => {
    ...
    try {
      ...
      showNotify("Copy failed — please try again.");
    }
  };
  ...
  const buyNova = () => {
    showNotify(
      "NOVA is not live yet. Official buying will open after launch."
    );
  };
        ...
        <nav className="navbar">
          ...
          <div className="navRight">
            ...
            <button
              className="themeBtn"
              onClick={() =>
                showNotify("NOVA mode is already active ✦")
              }
            >
              ☼
            </button>
      ...
      <section className="hero section" id="home">
        <div className="heroContent">
          ...
          <div className="heroButtons">
            <button className="primaryBtn" onClick={buyNova}>
              🚀 BUY NOVA <span>→</span>
            </button>
      ...
      <section className="section">
        <div className="sectionHeader">
          <div>
            ...
            <p>Simple. Fair. For the people.</p>
          </div>
        </div>
        ...
        <div className="overviewGrid">
          ...
          >
            ...
            <span>Click to copy status</span>
          </button>
          ...
          <div className="priceCard">
            ...
            <small>Price will appear after launch</small>
          </div>
        </div>
      </section>
      ...
      <section className="section aboutSection" id="about">
        ...
        <div className="aboutText">
          ...
          <p>
            ...
            the energy of the internet and the unstoppable culture of
            crypto.
          </p>

          <p>
            The mission is simple: build a recognizable internet brand,
            create a fun community and launch transparently.
          </p>
        ...
        <div className="tokenomicsGrid">
          ...
          <div className="allocationCard">
            ...
            <p className="smallNote">
              * These are preliminary concept allocations and should
              be updated before any public launch.
            </p>
          </div>
        </div>
      </section>
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .countdown div {
          ...
          border-radius: 11px;
          box-shadow: inset 0 0 30px rgba(90, 70, 255, 0.05);
        }
        ...
        .planetSmall {
          ...
          box-shadow: 0 0 30px rgba(150, 130, 255, 0.2);
        }
        ...
        .chest {
          ...
          background: #080c21;
          box-shadow: 0 0 25px rgba(134, 71, 255, 0.45);
        }
        ...
        .rocket {
          ...
          font-size: 70px;
          transform: rotate(-20deg);
          filter: drop-shadow(0 0 25px #a24fff);
        ...
        .allocationCard {
          ...
          box-shadow: inset 0 0 40px rgba(70, 70, 255, 0.03);
        }
        ...
        .fakeChart path {
          filter: drop-shadow(0 0 7px #8c4eff);
        }
        ...
        .miniPlanet {
          ...
          box-shadow: 0 0 60px rgba(30, 174, 255, 0.25);
        }
        ...
        .donut {
          ...
          display: grid;
          place-items: center;
          box-shadow: 0 0 50px rgba(119, 67, 255, 0.2);
        }
        ...
        .roadCard {
          ...
          box-shadow: inset 0 0 50px rgba(145, 65, 255, 0.05);
        }
        ...
        .communityPlanet {
          ...
          opacity: 0.85;
          box-shadow: 0 0 70px rgba(35, 151, 255, 0.25);
        }
